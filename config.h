...
const char *spcmd3[] = {TERMINAL, "-n", "spkeep", "-e", "sh", "-c", "keepassxc", NULL};
...
static const Rule rules[] = {
    ...
    {"Navigator", "firefox", "Mozilla Firefox", 0,          0,         0,          1,         -1},
...
static Key keys[] = {
    ...
    {MODKEY,             XK_Left, spawn, {.v = (const char *[]){"mpc", "prev", NULL}}},
    {MODKEY | ShiftMask, XK_Left, spawn, {.v = (const char *[]){"mpc", "seek", "0%", NULL}}},
    {MODKEY,             XK_Right, spawn, {.v = (const char *[]){"mpc", "next", NULL}}},
    {MODKEY | ShiftMask, XK_Right, spawn, {.v = (const char *[]){"mpc", "repeat", NULL}}},
